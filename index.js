...
async function run() {
    try {
        ...
        // Create new Collection and added by specific booking:-
...
/**
    ...
    * app.patch('/booking/:id) //   updated only one booking
    * app.delete('/booking/:id) //  specific service item delete
   */